...
export const NumberField = createComponent<NumberFieldOptions>((props, forwardedRef) => {
  ...
  const { inputProps, labelProps } = useNumberField({ ...props }, state, fieldRef);
  ...
  return (
    <NumberFieldBase
      ...
      ref={forwardedRef}
      className={classes}
      // helperNumberProps={mergeProps(descriptionProps, errorMessageProps, helperTextProps)}
