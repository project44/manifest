...
import type { FocusableRef, PressEvent } from '@react-types/shared';
...
const Button = React.forwardRef(
  (props: ButtonProps, forwardedRef: FocusableRef<HTMLButtonElement>) => {
    ...
    const buttonRef = useFocusableRef(forwardedRef);
    ...
    return (
      ...
      >
        ...
        {children}
        {endIcon && (
          <span className={cx('manifest-button__icon', 'manifest-button__icon--end')}>
            {endIcon}
          </span>
        )}
      </button>
