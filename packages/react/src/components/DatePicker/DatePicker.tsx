...
import { CSS, cx, useDatePickerStyles } from './DatePicker.styles';
...
interface DatePickerProps extends AriaDatePickerProps<DateValue>, DOMProps {
  /**
...
DatePicker.toString = () => '.manifest-datepicker';
