...
import { Flex, NumberField, Select, SelectItem, Separator, Switch } from '../src';
...
Default.decorators = [() => <NumberField placeholder="Enter number..." />];
...
Sizes.decorators = [
  () => (
    <Flex css={{ gap: '$small' }} orientation="vertical">
      <NumberField placeholder="Enter number..." size="medium" />
      <NumberField placeholder="Enter number..." size="small" />
    </Flex>
  ),
];
...
Invalid.decorators = [
  () => <NumberField placeholder="Enter number..." validationState="invalid" value={123} />,
];
