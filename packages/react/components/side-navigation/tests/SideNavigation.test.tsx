...
function Logo(props: React.HTMLAttributes<SVGSVGElement>) {
  return (
    <svg
      height="32"
...
describe('react-side-navigation', () => {
  it('should render and support collapsing', () => {
    render(
      <SideNavigation>
        <SideNavigationHeader>
  ...
  it('should support being controlled', () => {
    ...
    render(
      <SideNavigation isOpen={false} onOpenChange={onOpenChange}>
        <SideNavigationHeader>
          <Logo aria-label="logo" />
        </SideNavigationHeader>
        <SideNavigationContent>
  ...
  it('should being close by default', () => {
    const onOpenChange = jest.fn();

    render(
      <SideNavigation defaultOpen={false} onOpenChange={onOpenChange}>
        <SideNavigationHeader>
          <Logo aria-label="logo" />
        </SideNavigationHeader>
        <SideNavigationContent>
