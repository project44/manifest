export declare const focus: import("@stitches/react/types/styled-component").CssComponent<never, {
...
export declare const focusWithin: import("@stitches/react/types/styled-component").CssComponent<never, {}, {
    lg: `(min-width: ${string})`;
    md: `(min-width: ${string}})`;
    sm: `(min-width: ${string}})`;
    xl: `(min-width: ${string}})`;
