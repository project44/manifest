...
export const colorBrandActive = "linear-gradient(0deg, rgba(9, 21, 33, 0.4), rgba(9, 21, 33, 0.4)), linear-gradient(90deg, rgb(0, 114, 236) 0%, rgb(78, 0, 198) 163.65%, rgb(140, 24, 226)  191.59%)";
export const colorBrandHover = "linear-gradient(0deg, rgba(9, 21, 33, 0.2), rgba(9, 21, 33, 0.2)), linear-gradient(90deg, rgb(0, 114, 236) 0%, rgb(78, 0, 198) 163.65%, rgb(140, 24, 226)  191.59%)";
export const colorBrandGradient = "linear-gradient(90deg, rgb(0, 114, 236) 0%, rgb(78, 0, 198) 163.65%, rgb(140, 24, 226)  191.59%)";
...
export const shadowLarge = "0px -1px 2px rgba(61, 58, 180, 0.1), 0px 6px 14px rgba(61, 58, 180, 0.15)";
export const shadowMedium = "0px -1px 2px rgba(61, 58, 180, 0.1), 0px 4px 5px rgba(61, 58, 180, 0.15)";
export const shadowSmall = "0px -1px 2px rgba(61, 58, 180, 0.1), 0px 1px 2px rgba(61, 58, 180, 0.4)";
...
export const fontFamilyText = "\"Inter\", -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Oxygen-Sans, Ubuntu, Cantarell, \"Helvetica Neue\", sans-serif";
