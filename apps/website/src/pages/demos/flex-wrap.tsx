...
function FlexExample() {
  return (
    <Flex wrap gap="small">
      ...
      <Box css={{ backgroundColor: '$palette-blue-500', size: 64 }} />
      <Box css={{ backgroundColor: '$palette-red-500', size: 64 }} />
      <Box css={{ backgroundColor: '$palette-orange-500', size: 64 }} />
      <Box css={{ backgroundColor: '$palette-grey-500', size: 64 }} />
      <Box css={{ backgroundColor: '$palette-green-500', size: 64 }} />
      <Box css={{ backgroundColor: '$palette-purple-500', size: 64 }} />
      <Box css={{ backgroundColor: '$palette-pink-500', size: 64 }} />
      <Box css={{ backgroundColor: '$palette-green-500', size: 64 }} />
